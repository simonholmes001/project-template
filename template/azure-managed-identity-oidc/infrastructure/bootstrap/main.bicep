...
param targetResourceGroupName string = 'rg-{{REPO_NAME}}-${environmentName}'

@description('User-assigned managed identity used by GitHub Actions OIDC.')
param pipelineIdentityName string = 'id-{{REPO_NAME}}-github-actions'
